...
intersection() {
    ...
    cuboid([149.5, 119.5, 50], rounding = 3.6, edges = [LEFT+FRONT, RIGHT+FRONT, LEFT+BACK, RIGHT+BACK], anchor = [-1, -1, 1]);
}
...
difference(){
    ...
    translate([thick_out, thick_out, 0])
        cuboid([149.5 - thick_out*2, 119.5 - thick_out*2, 30], rounding = 3.6, edges = [LEFT+FRONT, RIGHT+FRONT, LEFT+BACK, RIGHT+BACK], anchor = [-1, -1, 1]);
}
